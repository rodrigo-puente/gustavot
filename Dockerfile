...
# docker build -t gustavot .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name gustavot gustavot
...
# Provide dummy DATABASE_URL during build so Rails can determine the adapter
